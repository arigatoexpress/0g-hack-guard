...
places Lighter orders, stakes LIT, or uploads live 0G Storage objects from the
browser workbench.
```
...
place Lighter orders, stake LIT, or upload live 0G Storage objects. The verified
