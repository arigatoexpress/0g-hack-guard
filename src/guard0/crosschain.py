...
CHAIN_TARGETS: tuple[ChainTarget, ...] = (
    ...
    ChainTarget(
        id="arbitrum_nova",
        name="Arbitrum Nova",
        kind="l2_low_cost_context",
        status="mainnet_anytrust",
        chain_id=42170,
        rpc_env="ARBITRUM_NOVA_RPC_URL",
        default_rpc="https://nova.arbitrum.io/rpc",
        http_status_env=None,
        default_http_status_url=None,
        ...
        evm_compatible=True,
        probe_default=True,
        capabilities=("read_only_rpc", "anytrust_context", "low_fee_wallet_preview"),
        x402_posture="custom_facilitator_required_or_supported_network_bridge_needed",
        proof_strategy="Use Nova as read-only low-cost wallet context; keep 0G as the common receipt/provenance anchor.",
        official_sources=(
            "https://docs.arbitrum.io/build-decentralized-apps/reference/node-providers",
        ),
        caveats=("Nova is context/readiness only here; no bridging, deposit, withdrawal, or settlement routes are enabled.",),
    ),
    ChainTarget(
        id="arbitrum_sepolia",
        name="Arbitrum Sepolia",
        kind="l2_testnet_demo_target",
        ...
        capabilities=(
            "read_only_rpc",
            "testnet_receipt_proof",
            "stylus_demo_target",
            "nodeinterface_gas_context",
        ),
        x402_posture="testnet_demo_only_no_live_settlement",
        proof_strategy=(
            "Use Arbitrum Sepolia for no-value demos of receipt contracts, "
            "gas/readiness checks, and pre-signer L2 policy proofs."
        ),
        official_sources=(
            "https://docs.arbitrum.io/build-decentralized-apps/reference/node-providers",
        ...
        caveats=("Testnet only. Any deployment still requires explicit operator approval outside this API.",),
    ),
    ChainTarget(
        id="polygon_pos",
        name="Polygon PoS",
